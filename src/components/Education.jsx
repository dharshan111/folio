    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <SchoolIcon sx={{ color: "#4a90e2", fontSize: { xs: 24, sm: 26, md: 28 } }} />
            Academic Journey
          </Typography>
                ...
                <Paper
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      ...
                      transform: { xs: "none", sm: "scale(1.01)", md: "scale(1.02)" },
                      boxShadow: { sm: `0 0 20px ${edu.color}20`, md: `0 0 30px ${edu.color}30` },
                    },
                  }}
                >
                  <Grid 
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Chip
                          icon={<LocationOnIcon sx={{ fontSize: { xs: 14, sm: 16 } }} />}
                          label={edu.location}
                          size="small"
                          sx={{
                            color: "#000",
        ...
        >
          ...
          >
            <EmojiEventsIcon sx={{ color: "#f1c40f", fontSize: { xs: 24, sm: 26, md: 28 } }} />
              ...
              >
                <Box sx={{ 
                  ...
                  <Box sx={{ width: "100%" }}>
                    ...
                    {item.location && (
                      <Chip
                        icon={<LocationOnIcon sx={{ fontSize: { xs: 12, sm: 12, md: 14 } }} />}
                        label={item.location}
                        size="small"
                        sx={{
                          mt: 1,
                          ...
                          fontSize: { xs: "0.65rem", sm: "0.65rem", md: "0.7rem" },
                          "& .MuiChip-icon": {
